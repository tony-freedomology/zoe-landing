...
const commitments = [
  ...
  },
  {
    ...
    body: "Success is not simply more messages, more notifications, or more time texting Zoe.",
  },
  {
      ...
      <main>
        ...
        <SectionShell tone="surface">
          ...
          <Body>
            ...
            <p>
              And sometimes it may mean encouraging them to put the phone down, become quiet, call a friend, ask forgiveness, go to church, or take one small act of obedience.
            </p>
          </Body>
          <PullQuote>
        ...
        <SectionShell tone="surface">
          ...
          <ul className="mt-6 space-y-2.5">
            {practiceDo.map((item) => (
              ...
              >
                <span aria-hidden="true" className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-zoe-sap text-[0.8rem] font-extrabold text-white">✓</span>
                {item}
              </li>
            ))}
          </ul>
          ...
          <ul className="mt-6 space-y-2.5">
            {practiceDont.map((item) => (
              <li
                ...
                className="flex gap-3.5 rounded-2xl bg-white px-4 py-3.5 text-[1.02rem] font-semibold leading-6 text-zoe-ink ring-1 ring-zoe-outline/40"
              >
                <span aria-hidden="true" className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-zoe-ink text-[0.95rem] font-extrabold text-white">×</span>
                {item}
              </li>
            ))}
          </ul>
        ...
        <SectionShell tone="surface">
          ...
          <ol className="mt-8 space-y-2.5">
            {commitments.map((item, index) => (
              <li
                key={item.title}
                className="flex gap-4 rounded-[1.25rem] bg-white px-5 py-5 ring-1 ring-zoe-outline/40"
              >
                <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-zoe-sap text-sm font-extrabold tabular-nums text-white">
        ...
        <section className="bg-zoe-ink px-5 py-20 sm:px-6 md:py-28">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-10 space-y-5 text-[1.08rem] font-medium leading-[1.85] text-white/72 sm:text-[1.12rem]">
              ...
              <p>
                And maybe it will help you put down your phone and take one faithful step.
              </p>
