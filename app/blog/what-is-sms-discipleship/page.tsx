    ...
    <div className="min-h-screen text-slate-900 font-sans">
      ...
      <section className="bg-gradient-to-b from-[#0a2e1f] to-[#061a12] py-32 px-6 pt-40">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl tracking-tighter-editorial font-serif text-white leading-[1.1] font-bold mb-6">What Is SMS Discipleship?</h1>
      ...
      <article className="py-16 px-6 bg-white">
        <div className="mx-auto max-w-3xl">
          <div className="prose prose-slate max-w-none text-slate-700 font-medium leading-relaxed text-lg space-y-6">
            ...
            <h2 className="text-3xl tracking-tighter-editorial font-serif text-slate-900 font-bold mt-10 mb-4">What Is SMS Discipleship?</h2>
            ...
            <hr className="border-slate-200 my-10" />
            <h2 className="text-3xl tracking-tighter-editorial font-serif text-slate-900 font-bold mt-10 mb-4">Why the Discipleship Gap Is So Real</h2>
            ...
            <hr className="border-slate-200 my-10" />
            <h2 className="text-3xl tracking-tighter-editorial font-serif text-slate-900 font-bold mt-10 mb-4">Why Text Messages Work When Other Things Don&apos;t</h2>
            ...
            <hr className="border-slate-200 my-10" />
            <h2 className="text-3xl tracking-tighter-editorial font-serif text-slate-900 font-bold mt-10 mb-4">It&apos;s Not an App</h2>
            ...
            <hr className="border-slate-200 my-10" />
            <h2 className="text-3xl tracking-tighter-editorial font-serif text-slate-900 font-bold mt-10 mb-4">The Two Questions That Change Everything</h2>
            ...
            <hr className="border-slate-200 my-10" />
            <h2 className="text-3xl tracking-tighter-editorial font-serif text-slate-900 font-bold mt-10 mb-4">The Three Rhythms of a Discipleship Day</h2>
            ...
            <hr className="border-slate-200 my-10" />
            <h2 className="text-3xl tracking-tighter-editorial font-serif text-slate-900 font-bold mt-10 mb-4">Why the Church Needs This Right Now</h2>
            ...
            <hr className="border-slate-200 my-10" />
            <h2 className="text-3xl tracking-tighter-editorial font-serif text-slate-900 font-bold mt-10 mb-4">What SMS Discipleship Is and Isn&apos;t</h2>
            ...
            <hr className="border-slate-200 my-10" />
            <h2 className="text-3xl tracking-tighter-editorial font-serif text-slate-900 font-bold mt-10 mb-4">Zoe: Built for SMS Discipleship</h2>
      ...
      <section className="py-20 px-6 bg-[#0a2e1f]">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl md:text-4xl tracking-tighter-editorial font-serif text-white font-bold leading-[1.1] mb-4">Try it for yourself.</h2>
