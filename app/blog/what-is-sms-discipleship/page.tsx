    ...
    <div className="min-h-screen text-zoe-ink">
      <section className="relative overflow-hidden bg-[#141008] py-32 px-6 pt-40">
        ...
        <div className="relative z-20 mx-auto max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl tracking-tight font-sans text-white leading-[1.1] font-bold mb-6">What Is SMS Discipleship?</h1>
          <p className="text-xl text-zoe-outline font-medium leading-relaxed">SMS discipleship is daily spiritual growth that happens through text messages — no app, no login, no friction. Here&apos;s why it works when nothing else does.</p>
            </div>
      </section>
<article className="py-16 px-6 bg-white">
        <div className="mx-auto max-w-3xl">
          <div className="prose prose-slate max-w-none text-zoe-muted font-medium leading-relaxed text-lg space-y-6">
            ...
            <h2 className="text-3xl tracking-tight font-sans text-zoe-ink font-bold mt-10 mb-4">The Problem Nobody Talks About</h2>
            ...
            <hr className="border-zoe-outline/40 my-10" />
            <h2 className="text-3xl tracking-tight font-sans text-zoe-ink font-bold mt-10 mb-4">So What Is SMS Discipleship?</h2>
            ...
            <hr className="border-zoe-outline/40 my-10" />
            <h2 className="text-3xl tracking-tight font-sans text-zoe-ink font-bold mt-10 mb-4">Why Text Messages Specifically?</h2>
            <p>Three reasons:</p>
            <p className="font-bold text-zoe-ink">1. Open rates.</p>
            ...
            <p className="font-bold text-zoe-ink">2. No new behavior required.</p>
            ...
            <p className="font-bold text-zoe-ink">3. It works on any phone.</p>
            ...
            <hr className="border-zoe-outline/40 my-10" />
            <h2 className="text-3xl tracking-tight font-sans text-zoe-ink font-bold mt-10 mb-4">What Zoe Does With SMS Discipleship</h2>
            <p><a href="https://zoe.live" className="text-zoe-sap hover:underline" target="_blank" rel="noopener noreferrer">Zoe</a> is the tool I built to make this work. Here&apos;s how it actually plays out:</p>
            ...
            <hr className="border-zoe-outline/40 my-10" />
            <h2 className="text-3xl tracking-tight font-sans text-zoe-ink font-bold mt-10 mb-4">Who This Is For</h2>
            ...
            <hr className="border-zoe-outline/40 my-10" />
            <h2 className="text-3xl tracking-tight font-sans text-zoe-ink font-bold mt-10 mb-4">What SMS Discipleship Is Not</h2>
            ...
            <p>Zoe is live and free in beta. You can join the waitlist at <a href="https://zoe.live" className="text-zoe-sap hover:underline font-bold" target="_blank" rel="noopener noreferrer">zoe.live</a>.</p>
          ...
          <div className="mt-12 bg-zoe-surface rounded-3xl p-8 border border-zoe-outline/20 text-center">
            <p className="text-lg font-bold text-zoe-ink mb-3">Close the loop.</p>
            <p className="text-zoe-muted font-medium leading-relaxed mb-6">Join the Zoe waitlist and experience discipleship that fits inside your actual day.</p>
