    ...
    <div className="min-h-screen text-zoe-ink">
      <section className="relative overflow-hidden bg-[#141008] py-32 px-6 pt-40">
        ...
        <div className="relative z-20 mx-auto max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl tracking-tight font-sans text-white leading-[1.1] font-bold mb-6">I&apos;m a Former Worship Pastor Building an AI Discipleship Tool. Here&apos;s What I&apos;ve Learned.</h1>
          <p className="text-xl text-zoe-outline font-medium leading-relaxed">Building something for the church means wrestling with hard questions — about trust, about replacement anxiety, and about what technology should actually do in a faith context.</p>
            </div>
      </section>
<article className="py-16 px-6 bg-white">
        <div className="mx-auto max-w-3xl">
          <div className="prose prose-slate max-w-none text-zoe-muted font-medium leading-relaxed text-lg space-y-6">
            ...
            <h2 className="text-3xl tracking-tight font-sans text-zoe-ink font-bold mt-10 mb-4">The Question Pastors Actually Ask Me</h2>
            ...
            <p className="italic text-zoe-muted">&quot;Are you trying to replace us?&quot;</p>
            ...
            <hr className="border-zoe-outline/40 my-10" />
            <h2 className="text-3xl tracking-tight font-sans text-zoe-ink font-bold mt-10 mb-4">What Replacement Anxiety Gets Right</h2>
            ...
            <hr className="border-zoe-outline/40 my-10" />
            <h2 className="text-3xl tracking-tight font-sans text-zoe-ink font-bold mt-10 mb-4">The Discipleship Gap That Already Existed</h2>
            ...
            <hr className="border-zoe-outline/40 my-10" />
            <h2 className="text-3xl tracking-tight font-sans text-zoe-ink font-bold mt-10 mb-4">Five Questions Every Church Should Ask Before Using Any AI Tool</h2>
            <p>If your church is evaluating AI tools — for discipleship, for pastoral care, for anything — here&apos;s what I&apos;d ask:</p>
            <div className="bg-zoe-surface rounded-2xl p-8 border border-zoe-outline/20 space-y-8 not-prose">
              {[
                ...
                <div key={item.number} className="flex gap-5 items-start">
                  <div className="w-8 h-8 rounded-full bg-zoe-ink flex items-center justify-center flex-shrink-0 text-white text-sm font-bold">{item.number}</div>
                  <div>
                    <h3 className="font-bold text-zoe-ink text-base mb-2">{item.title}</h3>
                    <p className="text-zoe-muted text-sm leading-relaxed font-medium">{item.body}</p>
                  </div>
                </div>
              ))}
            </div>
            <hr className="border-zoe-outline/40 my-10" />
            <h2 className="text-3xl tracking-tight font-sans text-zoe-ink font-bold mt-10 mb-4">Why the Church Needs to Be at This Table</h2>
            ...
            <hr className="border-zoe-outline/40 my-10" />
            <h2 className="text-3xl tracking-tight font-sans text-zoe-ink font-bold mt-10 mb-4">What I&apos;m Actually Building</h2>
            <p><a href="https://zoe.live" className="text-zoe-sap hover:underline" target="_blank" rel="noopener noreferrer">Zoe</a> is an SMS discipleship tool for churches. Here&apos;s what that means in practice:</p>
            ...
            <hr className="border-zoe-outline/40 my-10" />
            <h2 className="text-3xl tracking-tight font-sans text-zoe-ink font-bold mt-10 mb-4">The Honest Version</h2>
            ...
            <p>If you&apos;re thinking about this stuff, check out <a href="https://zoe.live" className="text-zoe-sap hover:underline font-bold" target="_blank" rel="noopener noreferrer">zoe.live</a>. We&apos;re in beta, it&apos;s free, and I&apos;d genuinely love feedback from pastors and church leaders who are thinking about this stuff.</p>
          </div>

          <div className="mt-12 bg-zoe-surface rounded-3xl p-8 border border-zoe-outline/20 text-center">
            <p className="text-lg font-bold text-zoe-ink mb-3">Built for your church.</p>
            <p className="text-zoe-muted font-medium leading-relaxed mb-6">Zoe is an SMS discipleship tool that&apos;s transparent, privacy-first, and designed to work alongside pastoral leadership — not replace it.</p>
            <Link href="/#waitlist" className="inline-flex items-center gap-2 rounded-full bg-zoe-ink text-white px-8 py-4 text-base font-bold shadow-lg hover:bg-slate-700 transition-all duration-200">
