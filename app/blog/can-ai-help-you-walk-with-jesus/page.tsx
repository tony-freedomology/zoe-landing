    ...
    <div className="min-h-screen text-slate-900 font-sans">
      ...
      <section className="bg-gradient-to-b from-[#0a2e1f] to-[#061a12] py-32 px-6 pt-40">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl tracking-tighter-editorial font-serif text-white leading-[1.1] font-bold mb-6">Can AI Help You Walk With Jesus?</h1>
      ...
      <article className="py-16 px-6 bg-white">
        <div className="mx-auto max-w-3xl">
          <div className="prose prose-slate max-w-none text-slate-700 font-medium leading-relaxed text-lg space-y-6">
            ...
            <h2 className="text-3xl tracking-tighter-editorial font-serif text-slate-900 font-bold mt-10 mb-4">The Tension Is Real — And Worth Respecting</h2>
            ...
            <hr className="border-slate-200 my-10" />
            <h2 className="text-3xl tracking-tighter-editorial font-serif text-slate-900 font-bold mt-10 mb-4">&quot;Isn&apos;t This Replacing the Holy Spirit?&quot;</h2>
            ...
            <hr className="border-slate-200 my-10" />
            <h2 className="text-3xl tracking-tighter-editorial font-serif text-slate-900 font-bold mt-10 mb-4">&quot;Can a Machine Understand Spiritual Things?&quot;</h2>
            ...
            <hr className="border-slate-200 my-10" />
            <h2 className="text-3xl tracking-tighter-editorial font-serif text-slate-900 font-bold mt-10 mb-4">The Church Has Always Been Scared of the New Tool</h2>
            ...
            <hr className="border-slate-200 my-10" />
            <h2 className="text-3xl tracking-tighter-editorial font-serif text-slate-900 font-bold mt-10 mb-4">The Theology Behind This: Common Grace</h2>
            ...
            <hr className="border-slate-200 my-10" />
            <h2 className="text-3xl tracking-tighter-editorial font-serif text-slate-900 font-bold mt-10 mb-4">Here&apos;s What AI Can and Can&apos;t Actually Do</h2>
            ...
            <hr className="border-slate-200 my-10" />
            <h2 className="text-3xl tracking-tighter-editorial font-serif text-slate-900 font-bold mt-10 mb-4">Why I Built This Anyway</h2>
            ...
            <hr className="border-slate-200 my-10" />
            <h2 className="text-3xl tracking-tighter-editorial font-serif text-slate-900 font-bold mt-10 mb-4">The Line Worth Drawing</h2>
            ...
            <hr className="border-slate-200 my-10" />
            <h2 className="text-3xl tracking-tighter-editorial font-serif text-slate-900 font-bold mt-10 mb-4">Try It for Yourself</h2>
          ...
          <div className="mt-16 pt-10 border-t border-slate-200 flex gap-4 items-start">
            <div className="w-12 h-12 rounded-full bg-[#0a2e1f] flex items-center justify-center flex-shrink-0">
      ...
      <section className="py-20 px-6 bg-[#0a2e1f]">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl md:text-4xl tracking-tighter-editorial font-serif text-white font-bold leading-[1.1] mb-4">Close the loop.</h2>
