    ...
    <div className="min-h-screen text-slate-900">
      <section className="relative overflow-hidden bg-[#141008] py-32 px-6 pt-40">
        ...
        <div className="relative z-20 mx-auto max-w-3xl">
          ...
          <p className="text-xl text-slate-300 font-medium leading-relaxed">AI can&apos;t love you or know God&apos;s will — but it can remember what you said on Tuesday and ask about it on Friday. Here&apos;s an honest look at what that&apos;s worth.</p>
            </div>
      </section>
<article className="py-16 px-6 bg-white">
        <div className="mx-auto max-w-3xl">
          <div className="prose prose-slate max-w-none text-slate-700 font-medium leading-relaxed text-lg space-y-6">
            ...
            <p className="italic text-slate-600">Am I outsourcing something that should be between me and God?</p>
            <p className="italic text-slate-600">Is this just another distraction dressed up in spiritual clothing?</p>
            ...
            <hr className="border-slate-200 my-10" />
            <h2 className="text-3xl tracking-tighter-editorial text-slate-900 font-bold mt-10 mb-4">Common Grace</h2>
            ...
            <hr className="border-slate-200 my-10" />
            <h2 className="text-3xl tracking-tighter-editorial text-slate-900 font-bold mt-10 mb-4">What AI Can and Can&apos;t Actually Do</h2>
            ...
            <hr className="border-slate-200 my-10" />
            <h2 className="text-3xl tracking-tighter-editorial text-slate-900 font-bold mt-10 mb-4">Try It</h2>
