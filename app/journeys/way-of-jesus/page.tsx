  ...
  return (
    <div className="min-h-screen text-slate-900 font-sans">
      ...
      <section className="relative bg-[#0a2e1f] py-32 px-6 pt-40 overflow-hidden">
        <Image src="/images/journeys/way-of-jesus.jpg" alt="" fill className="object-cover opacity-40" priority />
        ...
        <div className="relative z-10 mx-auto max-w-3xl text-center">
          ...
          <h1 className="text-5xl md:text-6xl tracking-tighter-editorial font-serif text-white leading-[1.1] font-bold">The Way of Jesus</h1>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="mx-auto max-w-3xl">
          <h2 className="text-3xl md:text-4xl tracking-tighter-editorial font-serif text-slate-900 font-bold mb-10">The 40 Days</h2>
