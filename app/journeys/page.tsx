    ...
    <div className="min-h-screen text-zoe-ink bg-zoe-surface">
      ...
      <section className="py-24 px-6 bg-zoe-ink">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="text-lg text-zoe-outline font-medium leading-relaxed mb-10">Join the beta to build a rhythm of scripture, prayer, practice, and reflection by text.</p>
