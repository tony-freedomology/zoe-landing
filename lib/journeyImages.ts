...
/**
 * 640px WebP variant of a journey cover for card-sized displays (~300-420px).
 * Generated by scripts/optimize-images.mjs into public/images/journeys/cards/.
 */
export function getJourneyCardImagePath(imagePath: string): string {
  return imagePath.replace(/^\/images\/journeys\/([^/]+)\.jpg$/, "/images/journeys/cards/$1.webp");
}
