...
export default function JourneyLessonPage({
  ...
  return (
    <main className="relative min-h-[100svh] overflow-x-hidden bg-[#fafcfb] pb-24 pt-6 text-[#1f2937]">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(29,194,134,0.14),transparent_35%),radial-gradient(circle_at_bottom_right,rgba(29,194,134,0.08),transparent_28%)]" />
      ...
      <div className="relative mx-auto max-w-md px-4">
        <div className="mb-5 flex flex-wrap items-center justify-center gap-2">
          ...
          <div className="rounded-full bg-[#1dc286] px-3 py-2 text-[11px] font-semibold uppercase tracking-[0.22em] text-white shadow-[0_10px_22px_rgba(29,194,134,0.18)]">
            {lesson.readTime}
          </div>
        </div>
        ...
        <header className="relative pb-6 pt-3">
          ...
          <div className="relative z-10 -mt-7 px-5">
            <div className="rounded-[2.25rem] border border-white/80 bg-[rgba(255,255,255,0.86)] px-6 pb-7 pt-7 shadow-[0_26px_80px_rgba(15,31,26,0.12)] backdrop-blur-xl">
              <p className="text-center text-[11px] font-semibold uppercase tracking-[0.28em] text-[#1dc286]">
                {lesson.journey}
              </p>
              <h1 className="mt-3 text-center text-[2.6rem] font-medium leading-[0.94] tracking-[-0.07em] text-[#1f2937] font-sans">
        ...
        <section className="relative mt-3">
          <div className="absolute -left-1 top-2 h-10 w-10 rounded-full bg-[rgba(29,194,134,0.16)] blur-[2px]" />
          <div className="relative rotate-[-1.4deg] rounded-[2rem] border border-[#e5e7eb] bg-[#fafcfb] px-5 pb-6 pt-6 shadow-[0_16px_38px_rgba(15,31,26,0.06)]">
            <div className="flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-[1.2rem] bg-[rgba(29,194,134,0.12)] text-[#1dc286]">
        ...
        <section className="relative mt-6 pl-4 pt-3">
          <div className="absolute left-0 top-0 z-10 flex h-11 w-11 items-center justify-center rounded-full bg-[#1dc286] text-lg font-semibold text-white shadow-[0_12px_24px_rgba(29,194,134,0.18)]">
            ?
          </div>
          <div className="rotate-[1.4deg] rounded-[2rem] border border-[#e5e7eb] bg-white px-6 pb-6 pt-6 shadow-[0_16px_40px_rgba(15,31,26,0.07)]">
            ...
            <h2 className="mt-2 text-[1.9rem] font-medium tracking-[-0.05em] text-[#1f2937] font-sans">
            ...
            <ul className="mt-5 space-y-4">
              {lesson.prompts.map((prompt) => (
                <li
                  key={prompt}
                  className="rounded-[1.4rem] border border-[rgba(29,194,134,0.12)] bg-[#fafcfb] px-4 py-4 text-[15px] leading-7 text-[#374151]"
                >
                  <div className="flex items-start gap-3">
                    <span className="mt-1 inline-flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-[rgba(29,194,134,0.12)] text-xs font-semibold text-[#1dc286]">
                      +
                    </span>
                    <span>{prompt}</span>
                  </div>
        ...
        <section className="relative mt-6 pr-3">
          <div className="rotate-[-1.2deg] rounded-[2rem] border border-[#e5e7eb] bg-[#0f1f1a] px-6 py-6 text-white shadow-[0_18px_42px_rgba(15,31,26,0.16)]">
            <div className="flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-[1.2rem] bg-[rgba(255,255,255,0.08)] text-[rgba(29,194,134,0.82)]">
