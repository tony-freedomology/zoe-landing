...
export default function ZoeSVG({ variant = "default", color: customColor, fast = false, staticOnly = false }: ZoeSVGProps = {}) {
    ...
    if (staticOnly) {
        return (
            <div className="w-full flex items-center justify-center" style={gpuStyle}>
                <div
